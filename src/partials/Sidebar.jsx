...
function Sidebar({ sidebarOpen, setSidebarOpen }) {
  ...
  return (
    <div>
      ...
      >
        {/* Sidebar header */}
        <div className="flex justify-between mb-10 pr-3 sm:px-2 rounded-lg l:rounded-sm border border-slate-200 dark:border-slate-700 " style={{ boxShadow: '2px 2px 4px 1.5px rgba(0, 0, 0, 1)' }}>
          {/* Close button */}
          <button
            ref={trigger}
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3 rounded-lg l:rounded-sm border border-slate-200 dark:border-slate-700 " style={{ boxShadow: '2px 2px 4px 1.5px rgba(0, 0, 0, 1)' }}>
              {/* Dashboard */}
              <SidebarLinkGroup
                activecondition={
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            ...
                            <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200 border-slate-200 dark:border-slate-700 " style={{ boxShadow: '2px 2px 4px 1.5px rgba(0, 0, 0, 1)' }} >
                              Dashboard
                            </span>
                          </div>
                        </div>
